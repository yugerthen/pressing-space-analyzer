...
!\[Métriques tactiques](data/tactical\_metrics.jpg)
...
!\[Classification équipe](data/team\_classification.jpg)
...
ROBOFLOW\_API\_KEY=ta\_cle\_ici
...
Place une vidéo de match (vue large, caméra tactique) dans `data/raw/match\_clip.mp4`, puis :
...
Python · YOLOv8 (Roboflow Inference) · supervision (ByteTrack, InferenceSlicer) · OpenCV · scikit-learn (K-means)
